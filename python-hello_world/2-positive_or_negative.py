...
if number == 0:
    #"The number {} is zero." is a string that contains a placeholder {}. This is where the value of the number variable will be inserted.
...
elif number > 0:   #The elif statement in Python stands for "else if." It is used in conditional statements to test multiple conditions in a sequence
